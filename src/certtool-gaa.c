...
void gaa_help(void)
{
	...
	__gaa_helpsingle(0, "verify", "", "Verify a PEM encoded certificate chain. CA certificates must be loaded with --load-ca-certificate.");
	...
	__gaa_helpsingle(0, "dh-info", "", "Print information on Diffie-Hellman parameters.");
