 ...
 *  
 *  It has been AutoGen-ed  January 21, 2013 at 09:27:01 AM by AutoGen 5.16
...
typedef enum {
    ...
    INDEX_OPT_CPRINT                = 25,
    INDEX_OPT_NULL_PASSWORD         = 26,
    INDEX_OPT_CERTIFICATE_INFO      = 27,
    INDEX_OPT_CERTIFICATE_PUBKEY    = 28,
    INDEX_OPT_PGP_CERTIFICATE_INFO  = 29,
    INDEX_OPT_PGP_RING_INFO         = 30,
    INDEX_OPT_CRL_INFO              = 31,
    INDEX_OPT_CRQ_INFO              = 32,
    INDEX_OPT_NO_CRQ_EXTENSIONS     = 33,
    INDEX_OPT_P12_INFO              = 34,
    INDEX_OPT_P7_INFO               = 35,
    INDEX_OPT_SMIME_TO_P7           = 36,
    INDEX_OPT_KEY_INFO              = 37,
    INDEX_OPT_PGP_KEY_INFO          = 38,
    INDEX_OPT_PUBKEY_INFO           = 39,
    INDEX_OPT_V1                    = 40,
    INDEX_OPT_TO_P12                = 41,
    INDEX_OPT_TO_P8                 = 42,
    INDEX_OPT_PKCS8                 = 43,
    ...
    INDEX_OPT_OUTRAW                = 52,
    INDEX_OPT_BITS                  = 53,
    INDEX_OPT_SEC_PARAM             = 54,
    INDEX_OPT_DISABLE_QUICK_RANDOM  = 55,
    INDEX_OPT_TEMPLATE              = 56,
    INDEX_OPT_PKCS_CIPHER           = 57,
...
#define VALUE_OPT_CPRINT         25
#define VALUE_OPT_NULL_PASSWORD  26
#define VALUE_OPT_CERTIFICATE_INFO 'i'
#define VALUE_OPT_CERTIFICATE_PUBKEY 28
#define VALUE_OPT_PGP_CERTIFICATE_INFO 29
#define VALUE_OPT_PGP_RING_INFO  30
#define VALUE_OPT_CRL_INFO       'l'
#define VALUE_OPT_CRQ_INFO       32
#define VALUE_OPT_NO_CRQ_EXTENSIONS 129
#define VALUE_OPT_P12_INFO       130
#define VALUE_OPT_P7_INFO        131
#define VALUE_OPT_SMIME_TO_P7    132
#define VALUE_OPT_KEY_INFO       'k'
#define VALUE_OPT_PGP_KEY_INFO   134
#define VALUE_OPT_PUBKEY_INFO    135
#define VALUE_OPT_V1             136
#define VALUE_OPT_TO_P12         137
#define VALUE_OPT_TO_P8          138
#define VALUE_OPT_PKCS8          '8'
#define VALUE_OPT_RSA            140
#define VALUE_OPT_DSA            141
#define VALUE_OPT_ECC            142
#define VALUE_OPT_ECDSA          143
#define VALUE_OPT_HASH           144
#define VALUE_OPT_INDER          145
#define VALUE_OPT_INRAW          146
#define VALUE_OPT_OUTDER         147
#define VALUE_OPT_OUTRAW         148
#define VALUE_OPT_BITS           149

#define OPT_VALUE_BITS           (DESC(BITS).optArg.argInt)
#define VALUE_OPT_SEC_PARAM      150
