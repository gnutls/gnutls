...
LZO_EXTERN(int)
    __lzo_init(unsigned v, int s1, int s2, int s3, int s4, int s5, int s6,
	   int s7);
...
#endif
{
	...
	return __LZO_QUERY_DECOMPRESS(in, in_len, out, out_len, wrkmem, 0,
				      0);
#endif
