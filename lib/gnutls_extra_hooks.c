...
_gnutls_openpgp_cert_creation_time_func
...
_gnutls_openpgp_cert_request_func _E_gnutls_openpgp_request_key = NULL;
...
_gnutls_openpgp_cert_deinit_func _E_gnutls_openpgp_cert_deinit = NULL;
 ...
 _gnutls_openpgp_privkey_deinit_func privkey_deinit)
{
  ...
  _E_gnutls_openpgp_cert_deinit = key_deinit;
