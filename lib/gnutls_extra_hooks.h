...
typedef time_t (*_gnutls_openpgp_cert_creation_time_func)
(const gnutls_datum_t *);

typedef time_t (*_gnutls_openpgp_cert_expiration_time_func)
(const gnutls_datum_t *);

typedef int (*_gnutls_openpgp_cert_request_func)
...
typedef void (*_gnutls_openpgp_cert_deinit_func)
...
extern _gnutls_openpgp_cert_creation_time_func
_E_gnutls_openpgp_get_raw_key_creation_time;
extern _gnutls_openpgp_cert_expiration_time_func
_E_gnutls_openpgp_get_raw_key_expiration_time;
extern _gnutls_openpgp_fingerprint_func _E_gnutls_openpgp_fingerprint;
extern _gnutls_openpgp_cert_request_func _E_gnutls_openpgp_request_key;
...
extern _gnutls_openpgp_cert_deinit_func _E_gnutls_openpgp_cert_deinit;
...
(_gnutls_openpgp_verify_key_func verify_key,
 _gnutls_openpgp_cert_creation_time_func key_creation_time,
 _gnutls_openpgp_cert_expiration_time_func key_expiration_time,
 _gnutls_openpgp_fingerprint_func fingerprint,
 _gnutls_openpgp_cert_request_func request_key,
 ...
 _gnutls_openpgp_cert_deinit_func key_deinit,
