...
/* Salsa 20 */
#define GNUTLS_RSA_WITH_SALSA20_256_SHA1      {0xFA, 0xA4}
#define GNUTLS_RSA_WITH_SALSA20_256_UMAC_96      {0xFA, 0xA5}
#define GNUTLS_RSA_WITH_ESTREAM_SALSA20_256_SHA1      {0xFB, 0xA4}
#define GNUTLS_RSA_WITH_ESTREAM_SALSA20_256_UMAC_96      {0xFB, 0xA5}
...
/* Salsa20 */
  ENTRY (GNUTLS_RSA_WITH_SALSA20_256_SHA1,
  		...
  		GNUTLS_MAC_SHA1, GNUTLS_SSL3,
  		GNUTLS_DTLS_VERSION_MIN),
  ENTRY (GNUTLS_RSA_WITH_SALSA20_256_UMAC_96,
  		GNUTLS_CIPHER_SALSA20_256, GNUTLS_KX_RSA,
  ...
  ENTRY (GNUTLS_RSA_WITH_ESTREAM_SALSA20_256_SHA1,
  		...
  		GNUTLS_MAC_SHA1, GNUTLS_SSL3,
  		GNUTLS_DTLS_VERSION_MIN),
  ENTRY (GNUTLS_RSA_WITH_ESTREAM_SALSA20_256_UMAC_96,
  		GNUTLS_CIPHER_ESTREAM_SALSA20_256, GNUTLS_KX_RSA,
  		GNUTLS_MAC_UMAC_96, GNUTLS_SSL3,
  		GNUTLS_DTLS_VERSION_MIN),
