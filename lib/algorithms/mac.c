...
static const mac_entry_st hash_algorithms[] = {
	...
	{.name = "GOST28147-TC26Z-IMIT",
	 ...
	 .key_size = 32,
	 .block_size = 8},
	{.name = "GOST28147-CPA-IMIT",
	 .id = GNUTLS_MAC_GOST28147_CPA_IMIT,
	 .output_size = 4,
	 .key_size = 32,
	 .block_size = 8},
	{.name = "GOST28147-CPB-IMIT",
	 .id = GNUTLS_MAC_GOST28147_CPB_IMIT,
	 .output_size = 4,
	 .key_size = 32,
	 .block_size = 8},
	{.name = "GOST28147-CPC-IMIT",
	 .id = GNUTLS_MAC_GOST28147_CPC_IMIT,
	 .output_size = 4,
	 .key_size = 32,
	 .block_size = 8},
	{.name = "GOST28147-CPD-IMIT",
	 .id = GNUTLS_MAC_GOST28147_CPD_IMIT,
	 .output_size = 4,
	 .key_size = 32,
	 .block_size = 8},
	{.name = "MAC-NULL",
