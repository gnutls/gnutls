...
static const cipher_entry_st algorithms[] = {
	...
	{ .name = "GOST28147-CPA-CFB",
	  ...
	  .implicit_iv = 8,
	  .cipher_iv = 8},
	{ .name = "GOST28147-CPA-CNT",
	  .id = GNUTLS_CIPHER_GOST28147_CPA_CNT,
	  .blocksize = 8,
	  .keysize = 32,
	  .type = CIPHER_STREAM,
	  .implicit_iv = 8,
	...
	{ .name = "GOST28147-CPB-CFB",
	  ...
	  .implicit_iv = 8,
	  .cipher_iv = 8},
	{ .name = "GOST28147-CPB-CNT",
	  .id = GNUTLS_CIPHER_GOST28147_CPB_CNT,
	  .blocksize = 8,
	  .keysize = 32,
	  .type = CIPHER_STREAM,
	  .implicit_iv = 8,
	...
	{ .name = "GOST28147-CPC-CFB",
	  ...
	  .implicit_iv = 8,
	  .cipher_iv = 8},
	{ .name = "GOST28147-CPC-CNT",
	  .id = GNUTLS_CIPHER_GOST28147_CPC_CNT,
	  .blocksize = 8,
	  .keysize = 32,
	  .type = CIPHER_STREAM,
	  .implicit_iv = 8,
	...
	{ .name = "GOST28147-CPD-CFB",
	  ...
	  .implicit_iv = 8,
	  .cipher_iv = 8},
	{ .name = "GOST28147-CPD-CNT",
	  .id = GNUTLS_CIPHER_GOST28147_CPD_CNT,
	  .blocksize = 8,
	  .keysize = 32,
	  .type = CIPHER_STREAM,
	  .implicit_iv = 8,
