...
static gnutls_error_entry error_algorithms[] = {
	...
	ERROR_ENTRY("Error in file.", GNUTLS_E_FILE_ERROR, 1 ), 
	ERROR_ENTRY("Error in ASCII armoring.", GNUTLS_E_ASCII_ARMOR_ERROR, 1 ), 

	ERROR_ENTRY("ASN1: Element was not found.", GNUTLS_E_ASN1_ELEMENT_NOT_FOUND, 1 ), 
	ERROR_ENTRY("ASN1: Identifier was not found", GNUTLS_E_ASN1_IDENTIFIER_NOT_FOUND, 1 ), 
	ERROR_ENTRY("ASN1: Error in DER parsing.", GNUTLS_E_ASN1_DER_ERROR, 1 ), 
	ERROR_ENTRY("ASN1: Value was not found.", GNUTLS_E_ASN1_VALUE_NOT_FOUND, 1 ), 
	ERROR_ENTRY("ASN1: Generic parsing error.", GNUTLS_E_ASN1_GENERIC_ERROR, 1 ), 
	ERROR_ENTRY("ASN1: Value is not valid.", GNUTLS_E_ASN1_VALUE_NOT_VALID, 1 ), 
	ERROR_ENTRY("ASN1: Error in TAG.", GNUTLS_E_ASN1_TAG_ERROR, 1 ), 
	ERROR_ENTRY("ASN1: error in implicit tag", GNUTLS_E_ASN1_TAG_IMPLICIT, 1 ), 
	ERROR_ENTRY("ASN1: Error in type 'ANY'.", GNUTLS_E_ASN1_TYPE_ANY_ERROR, 1 ), 
	ERROR_ENTRY("ASN1: Syntax error.", GNUTLS_E_ASN1_SYNTAX_ERROR, 1 ), 
	ERROR_ENTRY("ASN1: Overflow in DER parsing.", GNUTLS_E_ASN1_DER_OVERFLOW, 1 ), 
