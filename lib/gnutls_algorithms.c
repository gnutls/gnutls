...
#define GNUTLS_SRP_3DES_EDE_CBC_SHA { 0xF5, 0x1B }
#define GNUTLS_SRP_ARCFOUR_MD5 { 0xF5, 0x18 }
#define GNUTLS_SRP_RIJNDAEL_128_CBC_SHA { 0xF5, 0x34 }
#define GNUTLS_SRP_RIJNDAEL_256_CBC_SHA { 0xF5, 0x3A }
#define GNUTLS_SRP_TWOFISH_128_CBC_SHA { 0xF5, 0x50 }
