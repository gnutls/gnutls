...
gnutls_session initialize_tls_session()
{
   ...
   const int kx_priority[] = { GNUTLS_KX_RSA, GNUTLS_KX_DHE_RSA,
...
int main()
{
   ...
   gnutls_certificate_allocate_server_credentials(&x509_cred);
   ...
   gnutls_certificate_free_server_credentials(x509_cred);
