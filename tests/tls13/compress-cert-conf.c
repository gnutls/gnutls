...
static void client(int fd)
{
	...
	if (client_ok)
		success("client: compressed cert received\n");
	else
		fail("client: didn't receive compressed cert\n");
...
static void server(int fd)
{
	...
	if (server_ok)
		success("server: compressed cert received\n");
	else
		fail("server: didn't receive compressed cert\n");
