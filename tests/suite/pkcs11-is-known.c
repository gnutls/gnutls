...
static const char *ca_list[MAX_CHAIN] = {"-----BEGIN CERTIFICATE-----\n"
...
"-----BEGIN CERTIFICATE-----\n"
"MIIHSjCCBjKgAwIBAgIKYRoYuQABAAAACzANBgkqhkiG9w0BAQUFADBSMQswCQYD\n"
"VQQGEwJVUzEaMBgGA1UEChMRSW50ZWwgQ29ycG9yYXRpb24xJzAlBgNVBAMTHklu\n"
"dGVsIEludHJhbmV0IEJhc2ljIFBvbGljeSBDQTAeFw0wNjA1MjQxOTU1NThaFw0x\n"
"MjA1MjQyMDA1NThaMFYxCzAJBgNVBAYTAlVTMRowGAYDVQQKExFJbnRlbCBDb3Jw\n"
"b3JhdGlvbjErMCkGA1UEAxMiSW50ZWwgSW50cmFuZXQgQmFzaWMgSXNzdWluZyBD\n"
"QSAxQTCCASIwDQYJKoZIhvcNAQEBBQADggEPADCCAQoCggEBALyKjd0f/Y9DM4Ns\n"
"mgKrsnsm5StkPuvPdS50S8pRusqfQJ289MIUq4Nc5yWZ6z6jYe5E0JYbT2MZdI9B\n"
"8Gxy3KtlzE4lKjyno0DeajgUD4ZLmFzrezTUwUxkoROinyXyYZI5M3H3ZrWH8mOL\n"
"30TUJYJeFVoCsXvtBxRhtYZOGcnHEgaa3rh2TTRa97fcQZCaKXGizycn/JyHdAtl\n"
"4ZwMLseJpS42iT0M7BJzpZdK1Lf8O4l0CMOTeyDin+QfIsktjVrMIEPfe0m6R/G1\n"
"3fiosnY8IeMAX2kNmk/nArwRF6X2jpwDU26ZfI8N8mJzny+wnJIWNXRnXTWv6yYG\n"
"JF17bisCAwEAAaOCBBwwggQYMBIGA1UdEwEB/wQIMAYBAf8CAQAwHQYDVR0OBBYE\n"
"FM/TNiAfU+8jV33LQdP9CqXs8aYgMAsGA1UdDwQEAwIBhjASBgkrBgEEAYI3FQEE\n"
"BQIDAQABMCMGCSsGAQQBgjcVAgQWBBSF4Xa4g9x8iryei0lAfBvTAcK4NDAZBgkr\n"
"BgEEAYI3FAIEDB4KAFMAdQBiAEMAQTAfBgNVHSMEGDAWgBRp6zCRHAOAgE4RFYhG\n"
"pOJBmtNpHzCCAaIGA1UdHwSCAZkwggGVMIIBkaCCAY2gggGJhlFodHRwOi8vd3d3\n"
"LmludGVsLmNvbS9yZXBvc2l0b3J5L0NSTC9JbnRlbCUyMEludHJhbmV0JTIwQmFz\n"
"aWMlMjBQb2xpY3klMjBDQSgxKS5jcmyGWmh0dHA6Ly9jZXJ0aWZpY2F0ZXMuaW50\n"
...
"Q049U2VydmljZXMsQ049Q29uZmlndXJhdGlvbixEQz1jb3JwLERDPWludGVsLERD\n"
"PWNvbT9jQUNlcnRpZmljYXRlP2Jhc2U/b2JqZWN0Q2xhc3M9Y2VydGlmaWNhdGlv\n"
"bkF1dGhvcml0eTANBgkqhkiG9w0BAQUFAAOCAQEAsPABC6tezKH7ld+8Pqg/kjuq\n"
"MXV9J1kv9mHJblZfZ1VuanGWdJFOAn7mqy69jR+monnWhIhit1yWyjyHFQkRuQvC\n"
"CIK9gZeY8DaZK97sb+awyAX8gDOPI/MCbTyMxuFJe1fvS7TtShZlz94o53Zlpj4H\n"
"QxVwNnq0aIo1bAD8yO/P5DR8/ZeQz+rCSo8s2dd+WUgpzMp4hhkUoRhOuATht4ns\n"
"IkmFlOn2FhG88yjv3ls1ZeXYjF2T5BEtJ/xw3TQZMq45GU1A/J3z0spvF1qP0LuK\n"
"nqr9F8lati0N33EuDNYH6kR4m/gyUPzTfzQio9gxYbcwQfPQt+PZoLzSSO9r6A==\n"
"-----END CERTIFICATE-----\n";
...
void doit(void)
{
	...
	/* this will fail as all the CA certificates share the same authority key identifier */
	if (ret == 0) {
		fail("gnutls_x509_trust_list_get_issuer should have failed\n");
		exit(1);
	}
